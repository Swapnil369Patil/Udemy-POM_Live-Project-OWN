...
public class TestConfig{
	...
	public static String from = "talkswap369patil@gmail.com";
	public static String password = "Swap@369";
	public static String[] to ={"swapnil369patil@gmail.com","swapnil222patil@gmail.com"};
